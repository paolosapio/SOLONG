...
/*   Updated: 2024/10/23 18:09:56 by psapio           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	is_collision_up(t_player *player, t_map *map)
{
	...
	corner_up_left = query_map_coordinate
		(map, player->y
			- player->speed + IMG_SIZE / 2, player->x + 7);
	corner_up_right = query_map_coordinate
		(map, player->y
			- player->speed + IMG_SIZE / 2, player->x + IMG_SIZE - 7);
	if (corner_up_left == '1')
		return (1);
...
int	is_collision_down(t_player *player, t_map *map)
{
	...
	corner_down_left = query_map_coordinate
		(map, player->y + IMG_SIZE + player->speed, player->x + 7);
	corner_down_right = query_map_coordinate
		(map, player->y + IMG_SIZE + player->speed, player->x + IMG_SIZE - 7);
...
int	is_collision_right(t_player *player, t_map *map)
{
	...
	corner_right_up = query_map_coordinate
		(map, player->y + IMG_SIZE
			/ 2, player->x + IMG_SIZE + player->speed - 7);
	corner_right_down = query_map_coordinate
		(map, player->y + IMG_SIZE, player->x + IMG_SIZE + player->speed - 7);
